...
import "./css/PublicPerformanceDetails.css";
...
function createPublicPosterDataUrl() {
  const svg = `
    <svg xmlns="http://www.w3.org/2000/svg" width="640" height="852" viewBox="0 0 640 852">
      ...
      <text x="72" y="630" fill="#ffffff" font-family="Arial, sans-serif" font-size="30" font-weight="700">MAIN STAGE / 2026.06.18 - 2026.06.20</text>
...
const publicPerformanceData = {
  ...
  placeName: "서울 돔 메인홀",
  playStartDate: "2026.06.18",
  playEndDate: "2026.06.20",
  playDate: "2026.06.18 ~ 2026.06.20",
  runningTime: 150,
...
export default function PublicPerformanceDetails({ user, onGoMain }) {
