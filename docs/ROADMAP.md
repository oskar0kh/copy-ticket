...
## 5. Phase 2 — 공연 정보 파싱 + 인터파크 UI 구현 + 타이머 구현
...
| 3-7 | 예매 버튼 활성화 타이머 구현 | 사용자가 5,10,15,30,60초 단위로 예매 버튼 활성화 시간 설정 가능, 시간 되면 버튼 활성화 |
